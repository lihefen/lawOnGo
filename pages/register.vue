    ...
    <div class="font-lexend antialiased">
        <div class="bg-[url('/image/register/banner-register.png')] bg-cover bg-[#F1FFF9] lg:min-h-screen">
            <div class="md:max-w-[492px] lg:max-w-[1280px] sm:px-4 xl:px-40 mx-auto py-6">
                <a href="/" class=""><img src="/image/register_logo.png" alt="logo-lawogo" class="mx-auto mb-3 w-[230px]"></a>
                <div>
                    ...
                    <div class="flex lg:flex-row flex-col gap-6">
                        ...
                        <div class="lg:w-[520px] space-y-3">
                            <div id="form-register" class="p-4 md:p-6 rounded-2xl bg-white md:shadow-[0_20px_50px_0_rgba(0,0,0,0.13)]" v-if="!showCode">
                                ...
                                <div class="space-y-4">
                                    <div class="space-y-2">
                                        ...
                                        <div>
                                            <el-input size="large" v-model="inputName" type="text" placeholder="Write your full name" ></el-input>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div>
                                            <el-input size="large" v-model="inputEmail" type="email" placeholder="Write your active email"></el-input>
                                        </div>
                                    </div>
                                    ...
                                    <p class="text-neutral-800 text-sm text-left"> By registering, I agree to LawOnGo’s<a href="/syarat-ketentuan" class="text-[#04A45E]"> Terms and 
                            ...
                            <div class="lg:w-[520px] h-fit p-4 md:p-6 rounded-2xl bg-white md:shadow-[0_20px_50px_0_rgba(0,0,0,0.13)] flex flex-col justify-between gap-4" v-if="showCode">

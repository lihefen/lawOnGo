 ...
 * @LastEditors: hean
 * @LastEditTime: 2025-06-17 14:27:56
-->
<template>
        ...
        <div class="grid place-items-center fixed overflow-auto bg-white top-0 left-0 h-full w-full md:bg-black md:bg-opacity-50 z-50 xl:px-36">
            ...
            <section>
                <div id="wrap-loginComponent">
                    <div id="register" class="w-screen h-screen rounded-t-3xl bg-[linear-gradient(180deg,#D7FFEE_0%,#FFFFFF_20%,#FFFFFF_100%)] md:rounded-3xl md:h-auto md:w-[465px] md:py-4 md:shadow-md">
                        <div class="px-6 lg:px-8  hidden md:block">
                            <div class="relative text-center pt-8">
                                <p class="text-black font-bold antialiased text-2xl">Login LawOnGo Accoun</p>
                                <button @click="hide" class="absolute right-0 top-0">
                                ...
                                <img src="/image/login_icon.png" class="absolute left-0 top-0" alt="">
                            </div>
                        </div>
                        <div class="md:px-8 px-6">
                                    ...
                                    <div id="border-line" class="my-4"><div class="border border-[#CED1D6]"></div>
                                </div>
                                ...
                                <div class="pb-8 pt-4">
                                    <div class="flex items-start gap-1">
                                        ...
                                        <p class="text-xs text-slate-500 antialiased"> Untuk pengalaman lebih baik, gunakan browser <span class="font-semibold">Google Chrome</span> atau <span class="font-semibold">Firefox</span></p>
                                    </div>
                                </div>
                        </div>
                    </div>
